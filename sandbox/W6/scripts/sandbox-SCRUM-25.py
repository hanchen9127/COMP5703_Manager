...
Standard library only. Requires the API running on localhost:8000.
    ...
    python sandbox-SCRUM-25.py new            # create a fresh item, print the URL
    python sandbox-SCRUM-25.py check <item>   # show who owns which draft
    python sandbox-SCRUM-25.py clean --yes    # delete tasks this script created
"""
...
def cmd_new() -> None:
    ...
    print("\nNow follow docs/sandbox/W6/tests/manual-test-SCRUM-25.md.")
    print(f"Check ownership at any point with:  python sandbox-SCRUM-25.py check {item_id}")
