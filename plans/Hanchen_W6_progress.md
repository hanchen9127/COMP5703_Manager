...
Repeatable in ten minutes — [`sandbox_scrum25_manual_test.md`](./sandbox_scrum25_manual_test.md),
with `sandbox_scrum25.py` to build a clean item each run.
...
**Anyone demoing** — use [`sandbox_scrum25_manual_test.md`](./sandbox_scrum25_manual_test.md). Do not
use the old `sandbox_text_00N` items; they are spent and all finalised.

---

*Plan: [`plan.md`](./plan.md) · Manual test: [`sandbox_scrum25_manual_test.md`](./sandbox_scrum25_manual_test.md) · Orientation: [`tut.md`](./tut.md)*
