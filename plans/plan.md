...
> **Verified in the running app** — [`sandbox_scrum25_manual_test.md`](./sandbox_scrum25_manual_test.md).
>
...
`sandbox_scrum25_manual_test.md` — rewritten in Chinese as a **9-step** walkthrough (2026-09-12).
...
> **Done 2026-09-13.** The story (now `docs/stories/current_user_stories.md`) cites the ownership
...
- [x] *(25)* Demonstrable in the running app — the 9-step walkthrough in
      [`sandbox_scrum25_manual_test.md`](./sandbox_scrum25_manual_test.md) passed 2026-09-12.
...
- [ ] Reviewed by someone other than you — **outstanding for SCRUM-25.** PR description ready in
      [`commits/PR-SCRUM-25.md`](./commits/PR-SCRUM-25.md), to open against `main` from
      `CS57-Hanchen`.
...
*Companion doc: [`tut.md`](./tut.md) — orientation for the codebase, how to run it, and a trace of
