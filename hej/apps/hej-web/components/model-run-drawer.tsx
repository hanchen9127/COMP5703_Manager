  ...
  return (
    <>
      <div className="pointer-events-none fixed top-24 right-2 z-30 hidden h-[calc(100vh-7rem)] 2xl:block">
        <div
          className={cn(
            "pointer-events-auto relative h-full w-[360px] max-w-[calc(100vw-1rem)] transition-transform duration-200 ease-out",
        ...
        >
          <button
            ...
            aria-label={open ? "Collapse model run panel" : "Expand model run panel"}
            aria-expanded={open}
