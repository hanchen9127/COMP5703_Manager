...
* `global/`
  top-level surfaces such as dashboard
* `project-portfolio/`
  global project collection surfaces such as `/projects` and `/projects/new`
* `project-workspace/`
...
* `task-item/`
  ...
  it may also include DS-owned task-item-aligned dataset, payload, and evaluation PRs when the work proves real execution usability rather than page composition
...
* document names should match the actual workspace surface name as closely as possible
