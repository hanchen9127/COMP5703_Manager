  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed z-50 border border-slate-900/10 bg-white/96 shadow-[0_18px_50px_rgba(15,23,42,0.14)] outline-none dark:border-white/10 dark:bg-slate-900/96 dark:shadow-[0_20px_60px_rgba(2,6,23,0.5)]",
          side === "right" &&
